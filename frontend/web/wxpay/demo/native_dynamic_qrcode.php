...
*/
	...
	//sign已填,商户无需重复填写
	$unifiedOrder->setParameter("body","资助驿渡");//商品描述
	//自定义订单号，此处仅作举例
	$timeStamp = time();
...
<body>
    <img alt="模式二扫码支付" src="http://paysdk.weixin.qq.com/example/qrcode.php?data=<?php echo urlencode($code_url);?>" style="width:150px;height:150px;"/>
